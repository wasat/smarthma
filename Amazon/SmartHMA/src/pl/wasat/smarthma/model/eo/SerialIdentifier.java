...
public class SerialIdentifier implements Serializable {
	...
	public SerialIdentifier with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public SerialIdentifier with__text(String __text) {
		this.__text = __text;
		return this;
	}
