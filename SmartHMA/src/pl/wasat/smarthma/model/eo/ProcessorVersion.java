...
public class ProcessorVersion implements Serializable {
	...
	public ProcessorVersion with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public ProcessorVersion with__text(String __text) {
		this.__text = __text;
		return this;
	}
