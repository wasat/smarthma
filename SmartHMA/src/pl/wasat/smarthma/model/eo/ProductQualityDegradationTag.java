...
public class ProductQualityDegradationTag implements Serializable {
	...
	public ProductQualityDegradationTag with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public ProductQualityDegradationTag with__text(String __text) {
		this.__text = __text;
		return this;
	}
