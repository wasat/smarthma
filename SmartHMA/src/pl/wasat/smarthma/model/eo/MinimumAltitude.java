...
public class MinimumAltitude implements Serializable {
	...
	public MinimumAltitude with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public MinimumAltitude with_uom(String _uom) {
		this._uom = _uom;
		return this;
	}
	...
	public MinimumAltitude with__text(String __text) {
		this.__text = __text;
		return this;
	}
