...
public class MaximumAltitude implements Serializable {
	...
	public MaximumAltitude with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public MaximumAltitude with_uom(String _uom) {
		this._uom = _uom;
		return this;
	}
	...
	public MaximumAltitude with__text(String __text) {
		this.__text = __text;
		return this;
	}
