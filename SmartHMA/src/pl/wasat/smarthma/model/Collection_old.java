...
public class Collection_old implements Parcelable, Comparator<Object> {

	public static Creator<Collection_old> CREATOR = new Creator<Collection_old>() {
		@Override
		public Collection_old createFromParcel(Parcel source) {
			return new Collection_old(source);
		}

		@Override
		public Collection_old[] newArray(int size) {
			return new Collection_old[size];
		}
	};
	...
	public Collection_old(String layerTitle) {
		this.id = -1;
		this.name = null;
...
/*	public WMSLayer(WMS_Capabilities.Layer layer) {
	...
	public Collection_old(Parcel source) {
	...
	public int compare(Object collection1, Object collection2) {
		Collection_old coll1 = (Collection_old) collection1;
		Collection_old coll2 = (Collection_old) collection2;
