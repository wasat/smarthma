	...
	*//**
	...
	public void loadProductItemDetails(Entry entry) {
		...
		getActivity()
				...
				.beginTransaction()
				.add(R.id.activity_base_details_container, fragment,
						"SearchProductDetailsFragment")
				.addToBackStack("SearchProductDetailsFragment").commit();
	...
	public void loadSearchResultProductsIntroDetailsFrag(Feed searchProductFeeds) {
		...
		getActivity()
				...
				.add(R.id.activity_base_details_container,
						productsIntroFragment, "SearchProductsIntroFragment")
				.addToBackStack("SearchProductsIntroFragment").commit();
