...
public class ProductsListAdapter extends ArrayAdapter<Entry> {

	public ProductsListAdapter(Activity activity, List<Entry> searchList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View rowView = inflater.inflate(R.layout.fragment_search_products_feeds, null);
		Entry searchItem = getItem(position);
		

		TextView textView = (TextView) rowView.findViewById(R.id.search_prod_list_feed_name);
		textView.setText(searchItem.getTitle());
		
		TextView dateView = (TextView) rowView.findViewById(R.id.search_prod_list_feed_dates);
...
//		}
		...
		if (!searchItem.isRead()){
			LinearLayout row = (LinearLayout) rowView.findViewById(R.id.search_prod_list_frag_layout);
