...
public class SmartHmaEoHandler extends DefaultHandler {
	...
	// private boolean isInInstruments = false;
	// private boolean isInPlatforms = false;
	...
	public void startElement(String uri, String localName, String qName,
		...
		// Result markup
			...
			browseList = new ArrayList<Browse>();
		...
		// MetaDataProperty Markups start
			...
			productQualityDegradationTagList = new ArrayList<ProductQualityDegradationTag>();
			...
			derivedFrom.set_xlink_href(atts.getValue("xlink:href"));
