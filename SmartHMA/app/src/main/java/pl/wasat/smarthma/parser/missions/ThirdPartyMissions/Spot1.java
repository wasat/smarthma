 ...
 */
public class Spot1 extends BaseParser implements SimpleMissionInterface {
    /**
     * The constant MISSION_ID.
     */
    public final static int MISSION_ID = 35;
    private final static String TITLE = "Spot 1";

    /**
     * Instantiates a new Spot 1.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Spot1(String pageUrl, Context context) {
