 ...
 */
public class NovaAvhrr extends BaseParser implements SimpleMissionInterface {
    private final static int MISSION_ID = 25;
    private final static String TITLE = "NOAA AVHRR";

    /**
     * Instantiates a new Nova avhrr.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public NovaAvhrr(String pageUrl, Context context) {
