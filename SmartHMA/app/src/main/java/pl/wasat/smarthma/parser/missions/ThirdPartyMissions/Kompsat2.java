 ...
 */
public class Kompsat2 extends BaseParser implements SimpleMissionInterface {
    private final static int MISSION_ID = 23;
    private final static String TITLE = "KOMPSAT-2";

    /**
     * Instantiates a new Kompsat 2.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Kompsat2(String pageUrl, Context context) {
