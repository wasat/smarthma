 ...
 */
public class Spot3 extends BaseParser implements SimpleMissionInterface {
    /**
     * The constant MISSION_ID.
     */
    public final static int MISSION_ID = 37;
    private final static String TITLE = "Spot 3";

    /**
     * Instantiates a new Spot 3.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Spot3(String pageUrl, Context context) {
