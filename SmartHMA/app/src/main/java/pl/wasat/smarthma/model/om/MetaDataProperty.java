...
public class MetaDataProperty implements Serializable {
    ...
    /**
     * Gets earth observation meta data.
     *
     * @return the earth observation meta data
     */
    ...
    /**
     * Sets earth observation meta data.
     *
     * @param earthObservationMetaData the earth observation meta data
     */
