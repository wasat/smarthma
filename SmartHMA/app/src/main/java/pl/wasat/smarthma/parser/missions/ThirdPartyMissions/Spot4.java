 ...
 */
public class Spot4 extends BaseParser implements SimpleMissionInterface {
    /**
     * The constant MISSION_ID.
     */
    public final static int MISSION_ID = 38;
    private final static String TITLE = "Spot 4";

    /**
     * Instantiates a new Spot 4.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Spot4(String pageUrl, Context context) {
