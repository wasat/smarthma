 ...
 */
public class Odin extends BaseParser implements SimpleMissionInterface {
    private final static int MISSION_ID = 26;
    private final static String TITLE = "Odin";

    /**
     * Instantiates a new Odin.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Odin(String pageUrl, Context context) {
