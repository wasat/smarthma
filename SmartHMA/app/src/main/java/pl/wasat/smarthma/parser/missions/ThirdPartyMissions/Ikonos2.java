 ...
 */
public class Ikonos2 extends BaseParser implements SimpleMissionInterface {
    private final static int MISSION_ID = 21;
    private final static String TITLE = "Ikonos-2";

    /**
     * Instantiates a new Ikonos 2.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Ikonos2(String pageUrl, Context context) {
