...
public class PolarisationMode implements Serializable {
	...
	public PolarisationMode with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public PolarisationMode with__text(String __text) {
		this.__text = __text;
		return this;
	}
