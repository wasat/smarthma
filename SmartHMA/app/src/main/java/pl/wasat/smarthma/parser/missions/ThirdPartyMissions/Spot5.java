 ...
 */
public class Spot5 extends BaseParser implements SimpleMissionInterface {
    /**
     * The constant MISSION_ID.
     */
    public final static int MISSION_ID = 39;
    private final static String TITLE = "Spot 5";

    /**
     * Instantiates a new Spot 5.
     *
     * @param pageUrl the page url
     * @param context the context
     */
    public Spot5(String pageUrl, Context context) {
