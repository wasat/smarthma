...
public class LastOrbitNumber implements Serializable {
	...
	public LastOrbitNumber with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public LastOrbitNumber with__text(String __text) {
		this.__text = __text;
		return this;
	}
