 ...
 */
public class Spot extends BaseParser implements SimpleMissionInterface {
    private final static int MISSION_ID = 34;
    private final static String TITLE = "Spot";

    public Spot(String pageUrl, Context context) {
