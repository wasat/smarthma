...
public class SwathIdentifier implements Serializable {
	...
	public SwathIdentifier with__prefix(String __prefix) {
		this.__prefix = __prefix;
		return this;
	}
	...
	public SwathIdentifier with__text(String __text) {
		this.__text = __text;
		return this;
	}
